...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::middleware(['role:Admin Universitas', 'permission:Melihat hasil perhitungan'])->group(function () {
        ...
        Route::get('/detail-perhitungan-perkelas-oleh-admin-universitas', [AdminUniversitasController::class, 'detailPerhitunganPerkelas']);
    ...
    Route::middleware(['role:Kaprodi', 'permission:Melihat hasil perhitungan'])->group(function () {
        ...
        Route::get('/daftar-mata-kuliah-oleh-kaprodi', [KaprodiController::class, 'melihatDaftarMataKuliah']);
        Route::get('/detail-perhitungan-perkelas-oleh-kaprodi', [KaprodiController::class, 'detailPerhitunganPerkelas']);
    });
